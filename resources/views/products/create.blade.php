                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="{{ old('product_id') }}" type="text" class="@error('sku') is-invalid @enderror form-control form-control-lg" placeholder="Product Id" name="product_id">
                                @error('sku')
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('stock') }}" type="text" class="@error('stock') is-invalid @enderror form-control form-control-lg" placeholder="Stock" name="stock">
                                @error('sku')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
