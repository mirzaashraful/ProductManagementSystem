...
{{--                                <input value="{{ old('product_id', $product->product_id) }}" type="text" class="@error('sku') is-invalid @enderror form-control form-control-lg" placeholder="Product Id" name="product_id">--}}
{{--                                @error('sku')--}}
...
{{--                        </div>--}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ old('stock',$product->stock) }}" type="text" class="@error('stock') is-invalid @enderror form-control form-control-lg" placeholder="Stock" name="stock">
                                    @error('sku')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                    @enderror
                                </div>
...
{{--                                    @endif--}}
                                    @if ($product->image != "")
                                   <img  class="w-50 my-3" src="{{ asset('uploads/products/'.$product->image) }}" alt="{{$product->name}}">
                               @endif
                                </div>
                                <div class="d-grid">
